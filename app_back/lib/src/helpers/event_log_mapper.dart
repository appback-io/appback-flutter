...
class EventLogMapper {
    static Future<Map<String, dynamic>> mapParameters(String eventName, String router, Map<String, String> parameters) async {
        ...
        String composedStorage = await PlatformChannelMethods.getComposedStorage();
