...
class ToggleParentDto {
  ...
  ToggleParentDto(List<ToggleDto> toggles) : toggles = toggles ?? <ToggleDto>[];

  factory ToggleParentDto.fromJson(Map<String, dynamic> json) =>
      _$ToggleParentDtoFromJson(json);
